    ...
    <div class="d-flex" id="wrapper">
        <div class="bg-dark" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                ...
                <a href="./printadmin.php" target="_blank" class="list-group-item list-group-item-action bg-transparent second-text fw-bold active"><i class="fas fa-print me-2"></i>Print PDF</a>
            </div>
        </div>
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-dark bg-transparent py-4 px-4 justify-content-between">
                ...
                <form class="d-flex pencarian" role="search" action="" method="post">
                    <input class="form-control me-2 pe-5" type="text" placeholder="Cari Username Admin" name="keyword" autocomplete="off" id="keyword" />
