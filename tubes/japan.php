        ...
        <section>
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 featured-item pt-3">
                        <img src="img/Destination/Jepang/fuji.jpg" alt="" />
                        <div class="featured-item-content ps-4">
                            <span>
                                <i class="fas fa-map-marker-alt"></i>
                    ...
                    <div class="col-lg-4 col-md-6 featured-item pt-3">
                        <img src="img/Destination/Jepang/hiroshimapeacememorial.jpg" alt="" />
                        <div class="featured-item-content ps-4">
                            <span>
                                <i class="fas fa-map-marker-alt"></i>
                    ...
                    <div class="col-lg-4 col-md-6 featured-item pt-3">
                        <img src="img/Destination/Jepang/matsumotocastle.jpg" alt="" />
                        <div class="featured-item-content ps-4">
                            <span>
                                <i class="fas fa-map-marker-alt"></i>
                    ...
                    <div class="col-lg-4 col-md-6 featured-item pt-3">
                        <img src="img/Destination/Jepang/nara.jpg" alt="" />
                        <div class="featured-item-content ps-4">
                            <span>
                                <i class="fas fa-map-marker-alt"></i>
                                Manggarai Barat, NTT.
